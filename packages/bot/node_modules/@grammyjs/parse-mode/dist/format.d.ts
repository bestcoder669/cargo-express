 ...
 * @param stringLike The `Stringable` to format.
 */
declare const expandableBlockquote: (stringLike: Stringable) => FormattedString;
/**
 ...
 */
declare const customEmoji: (placeholder: Stringable, emoji: string) => FormattedString;
/**
...
export { blockquote, bold, code, customEmoji, expandableBlockquote, fmt, FormattedString, italic, link, linkMessage, mentionUser, pre, spoiler, strikethrough, underline, };
